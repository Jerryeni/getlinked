...
<section class="w-full relative flex flex-col px-20 0 relative bg-primary-500 mt-0">
	<div
		class="flex w-full justify-between items-center mt-2 relative bg-[url(/images/Purple-Lens-Flare-PNG.png')] object-contain"
	>
		<div class="text-left w-full">
			<h1 class="font-bold text-2xl">
				Rules and
				<br /> <span class="text-secondary-500">Guidelines</span>
			</h1>

			<p class="font-medium text-sm leading-10">
		...
		<div class="w-full object-fit">
			<img src="/images/rules.png" class="object-cover" alt="man wearing glass" />

			<!-- <div class="">
				<img
					src="/images/bigidea.svg"
					class="object-fit absolute top-0 right-8 motion-safe:animate-spin-slow"
					width="40%"
